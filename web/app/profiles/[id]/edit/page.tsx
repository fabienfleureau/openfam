        ...
        <div className="min-h-screen bg-background">
          ...
          <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div className="theme-card p-6 text-error">
              ...
              <Link
                href="/profiles"
                className="inline-block mt-4 px-4 py-2 rounded-md bg-error/10 text-error hover:bg-error/20 transition-colors"
              >
                Back to Profiles
              </Link>
            </div>
      ...
      <div className="min-h-screen bg-background">
        ...
        <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="mb-8 opacity-0 animate-fade-in">
            <h2 className="font-display text-3xl mb-2">Edit Profile</h2>
            <p className="text-muted-foreground">
              Update profile settings and device assignments
            </p>
          </div>
